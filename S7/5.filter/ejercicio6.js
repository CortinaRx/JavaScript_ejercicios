...
//con los streamers que incluyan el caracter 'Legends' en su propiedad .gameMorePlayed.
...
const newStreamer = streamers.filter(streamer => {
   const stream = streamer.gameMorePlayed.includes('League');
  
   if(streamer.age > 35 && stream){
